package com.framework.helper.excelHelper;
...
// setContent() writes test results to a single Cell of Excel based on given Header, testcaseID, celldata
	public static void setResults(String Filepath,String Sheetname, String Header,String testcaseID,String celdata ) throws IOException{
		...
		for(int i=0;i<sheet.getLastRowNum();i++){
			for(int j=0;j<sheet.getRow(0).getLastCellNum();j++){
				...
				System.out.println("Test status before Execution: "+getCellData(i,j));
				setContent(Filepath,Sheetname,i,j,celdata);
				System.out.println("Test status After Execution: "+getCellData(i,j));		
				}	
			}
		}
	...
	public static void main(String[] args) throws IOException{
		...
		//Parameterization.setResults(System.getProperty("user.dir")+"/src/main/resources/Test-result/testout.xlsx","Sheet1", "Status","TC_1","Pending");
